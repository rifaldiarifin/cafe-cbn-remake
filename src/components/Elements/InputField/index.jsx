  ...
  const triggerInput = {
    ...
    email: (e) => {
      ...
      if (!input.value.includes("@"))
        return setMessage(`Invalid email! "@"`, input.parentElement);

      // if value contains double or more symbol "@"
      if (checkDoubleA(input.value))
        return setMessage(`Invalid email double! "@"`, input.parentElement);
    ...
    phoneID: (e) => {
      ...
      if (!checkMobilePhoneID(input.value))
        return setMessage("Not a phone number ID!", input.parentElement);
    ...
    case "password":
      ...
      return (
        ...
        >
          ...
          ></Input>
          <span
            className="see-pass icons8-regular hide"
